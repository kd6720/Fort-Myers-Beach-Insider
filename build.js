...
.dual-highlight{position:relative;overflow:hidden;color:#fff;border-radius:12px;padding:2rem;text-align:center}
.dual-highlight-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0}
.dual-highlight::after{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(40,72,81,0.85),rgba(51,93,104,0.85));z-index:0}
.dual-highlight>*{position:relative;z-index:1}
...
/* Lead */
.lead-section{position:relative;overflow:hidden;color:#fff;border-radius:16px;padding:3rem;text-align:center;margin-top:0}
.lead-section-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0}
.lead-section::after{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(40,72,81,0.88),rgba(0,158,183,0.82));z-index:0}
