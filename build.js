...
<meta property="og:image" content="assets/prospectus-pages/page-01.png">
...
h2{font-size:clamp(1.8rem,4vw,2.8rem);font-weight:800;color:#0F2440;margin-bottom:1rem;letter-spacing:-0.02em}
h3{font-size:1.25rem;font-weight:700;color:#0F2440}
section{padding:5rem 1.5rem;max-width:1200px;margin:0 auto}
.section-label{font-size:0.8rem;font-weight:600;text-transform:uppercase;letter-spacing:0.1em;color:#0EA5A0;margin-bottom:0.75rem}
hr{width:60px;height:3px;background:#0EA5A0;border:none;margin:1rem 0 2rem}
...
nav .logo{font-weight:800;font-size:1.1rem;color:#0F2440;display:flex;align-items:center;gap:0.5rem}
nav .logo span{color:#0EA5A0}
...
nav .nav-links a:hover{color:#0EA5A0}

/* Hero */
.hero{min-height:100vh;display:flex;align-items:center;position:relative;background:linear-gradient(135deg, #0F2440 0%, #164E63 40%, #0EA5A0 100%);color:#fff;padding:7rem 1.5rem 5rem}
.hero::before{content:'';position:absolute;inset:0;background:url('assets/prospectus-pages/page-11.png') center/cover;opacity:0.15}
...
.btn-primary{background:#fff;color:#0F2440}
...
.btn-teal{background:#0EA5A0;color:#fff}
...
.dual-card h3{color:#0EA5A0;margin-bottom:1rem}
.stat-row{display:flex;justify-content:space-between;padding:0.5rem 0;border-bottom:1px solid #F1F5F9;font-size:0.95rem}
.stat-row .val{font-weight:700;color:#0F2440}
.dual-highlight{background:linear-gradient(135deg,#0F2440,#164E63);color:#fff;border-radius:12px;padding:2rem;text-align:center}
...
.rebuild-card h3{color:#0EA5A0;margin-bottom:0.75rem;font-size:1rem}
...
.rebuild-card ul li::before{content:'•';position:absolute;left:0;color:#0EA5A0;font-weight:700}
.rebuild-card ul li.check::before{content:'✓';color:#10B981;font-weight:700}
...
.market-table tr td:last-child{font-weight:600;color:#0F2440;text-align:right}
.market-table thead td{font-weight:700;color:#0EA5A0;font-size:0.85rem;text-transform:uppercase;letter-spacing:0.05em}
...
.regional-card{background:#fff;border-radius:12px;padding:2rem;border:1px solid #E2E8F0;border-top:4px solid #0EA5A0}
.regional-card h3{color:#0F2440;margin-bottom:0.75rem}
...
.ladder-table th{text-align:left;padding:0.75rem 1rem;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;color:#0EA5A0;border-bottom:2px solid #E2E8F0}
.ladder-table td{padding:0.75rem 1rem;border-bottom:1px solid #F1F5F9;vertical-align:top}
.ladder-table td:first-child{font-weight:600;color:#0F2440}
.ladder-table td:nth-child(2){color:#0EA5A0;font-weight:600}
.ladder-table td:last-child{color:#475569;font-size:0.85rem}
.ladder-best{border-left:4px solid #10B981;background:#F0FDF4}
...
.risk-card h4{font-size:0.95rem;margin-bottom:0.35rem;color:#0F2440}
.risk-card p{color:#64748B}

/* Lead */
.lead-section{background:linear-gradient(135deg,#0F2440,#164E63);color:#fff;border-radius:16px;padding:3rem;text-align:center;margin-top:0}
...
.lead-form input:focus{outline:3px solid #0EA5A0}
.lead-form button{padding:0.8rem 1.5rem}
.lead-status{font-size:0.85rem;margin-top:0.75rem;min-height:1.5em}

/* Footer */
footer{background:#0F2440;color:#E2E8F0;padding:3rem 1.5rem;font-size:0.85rem}
...
.footer-grid a:hover{color:#0EA5A0}
.footer-bottom{border-top:1px solid #1E3A5F;margin-top:2rem;padding-top:1.5rem;text-align:center;color:#64748B;font-size:0.8rem;max-width:1200px;margin-left:auto;margin-right:auto}
