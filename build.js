...
.hero::before{content:'';position:absolute;inset:0;background:url('assets/photos/01-hero-beach-aerial.jpg') center/cover;opacity:0.15}
...
.dual-highlight{background:linear-gradient(135deg,rgba(40,72,81,0.85),rgba(51,93,104,0.85)),url('assets/photos/02-dual-use-beach-house.jpg') center/cover;color:#fff;border-radius:12px;padding:2rem;text-align:center}
...
/* Lead */
.lead-section{background:linear-gradient(135deg,rgba(40,72,81,0.88),rgba(0,158,183,0.82)),url('assets/photos/08-cta-sunset-dunes.jpg') center/cover;color:#fff;border-radius:16px;padding:3rem;text-align:center;margin-top:0}
...
<section id="island" style="position:relative">
  <div style="position:absolute;inset:0;background:url('assets/photos/03-island-rebuilt-pier.jpg') center/cover;opacity:0.08;pointer-events:none"></div>
