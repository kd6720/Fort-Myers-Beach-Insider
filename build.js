...
.hero::before{content:'';position:absolute;inset:0;background:url('assets/photos/hero-beach-house.png') center/cover;opacity:0.15}
...
.dual-highlight{background:linear-gradient(135deg,#284851,#335D68);color:#fff;border-radius:12px;padding:2rem;text-align:center}
...
/* Lead */
.lead-section{background:linear-gradient(135deg,#284851,#335D68);color:#fff;border-radius:16px;padding:3rem;text-align:center;margin-top:0}
